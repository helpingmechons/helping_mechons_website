...
export default async function CampaignsPage({ searchParams }) {
  ...
  const items = campaigns.length > 0 ? campaigns : [
    { id: "1", title: "Emergency Medical Fund",           slug: "emergency-medical-fund",   description: "Life-saving surgeries and primary care for families who cannot afford treatment.", goal_amount: 500000, current_amount: 145000, cover_image_url: getPhoto("medical-support"), category: "medical",   location: "Hyderabad",     featured: true  },
    { id: "2", title: "Daily Food for 500 Families",      slug: "daily-food-500-families",  description: "Nightly food distribution reaches 500+ homeless and destitute families.",          goal_amount: 200000, current_amount: 87500,  cover_image_url: getPhoto("food-distribution-1"), category: "food",      location: "Hyderabad",     featured: true  },
    { id: "3", title: "Education Kits — 200 Children",    slug: "education-kits-200-children",description: "School bags, books, and uniforms for 200 underprivileged students.",            goal_amount: 150000, current_amount: 62000,  cover_image_url: getPhoto("education-support"),   category: "education", location: "Visakhapatnam", featured: true  },
    { id: "4", title: "Monthly Grocery Kits — Elderly",   slug: "grocery-kits-elderly",     description: "Monthly kits containing rice, dal, oil, and essentials for the elderly.",        goal_amount: 100000, current_amount: 23000,  cover_image_url: getPhoto("grocery-support"),    category: "grocery",   location: "Hyderabad",     featured: false },
    { id: "5", title: "Orphanage Support — Vijayawada",   slug: "orphanage-support-vijayawada",description: "Monthly support covering food, clothing, school fees, and medical checkups.",   goal_amount: 250000, current_amount: 78000,  cover_image_url: getPhoto("orphanage-care"),     category: "orphanage", location: "Vijayawada",    featured: false },
  ];
                ...
                {items.map(c => {
                  ...
                  return (
                    <Link key={c.id} href={href}
                      className="card group flex flex-col hover:shadow-lift transition-all duration-300">
                      {/* Image */}
                      ...
                      <div className="p-6 flex flex-col flex-grow">
                        ...
                        <div>
                          <div className="flex justify-between text-label-md mb-2">
                            <span className="text-secondary font-semibold">₹{Number(c.current_amount).toLocaleString("en-IN")}</span>
                          ...
                          <p className="text-caption text-on-surface-variant mt-2">
                            Goal: ₹{Number(c.goal_amount).toLocaleString("en-IN")}
                          </p>
                        </div>
                        {/* CTA */}
                        <button className="mt-4 btn-primary w-full justify-center text-sm py-2.5">
