...
const CAUSES = [
  { id: "medical",   icon: "🏥", label: "Medical Support",      badge: "bg-blue-50 text-blue-700",   img: getPhoto("medical-support"),      cat: "Medical Aid",     pct: 82, raised: "₹82,450",  goal: "₹1,00,000", desc: "Providing free medical camps and life-saving surgeries to underserved communities across Hyderabad." },
  { id: "food",      icon: "🍛", label: "Food Distribution",    badge: "bg-orange-50 text-orange-700",img: getPhoto("food-distribution-1"),   cat: "Food Security",   pct: 94, raised: "₹87,500",  goal: "₹92,000",   desc: "Distributing hot meals and food packets to 500+ homeless families nightly across the city." },
  { id: "grocery",   icon: "🛒", label: "Grocery Kits",         badge: "bg-green-50 text-green-700",  img: getPhoto("grocery-support"),      cat: "Grocery Support", pct: 65, raised: "₹65,000",  goal: "₹1,00,000", desc: "Custom-packed grocery kits with rice, dal, oil, and essentials to sustain a family for a month." },
  { id: "education", icon: "📚", label: "Education Support",    badge: "bg-purple-50 text-purple-700",img: getPhoto("education-support"),     cat: "Education",       pct: 55, raised: "₹55,000",  goal: "₹1,00,000", desc: "School bags, textbooks, stationery, and uniforms for children in tribal schools and rural areas." },
  { id: "orphanage", icon: "🏠", label: "Orphanage Care",       badge: "bg-pink-50 text-pink-700",    img: getPhoto("orphanage-care"),       cat: "Child Care",      pct: 100,raised: "₹50,000",  goal: "₹50,000",   desc: "Regular visits to orphanages for meals, clothing, school fees, and emotional support for children." },
  { id: "elderly",   icon: "🧓", label: "Old Age Home Support", badge: "bg-amber-50 text-amber-700",  img: getPhoto("old-age-care"),         cat: "Elder Care",      pct: 25, raised: "₹25,000",  goal: "₹1,00,000", desc: "Monthly food, medicines, and companionship visits to elderly residents in old age homes." },
];
                  ...
                  <div className="p-5">
                    ...
                    <div>
                      ...
                      <div className="progress-bar">
                        <div className="progress-fill" style={{ width: `${cause.pct}%` }} />
                      </div>
                    </div>
                    <Link href="/donate" className="mt-4 btn-primary w-full justify-center py-2.5 text-sm">
                      Fund This Mission
                    </Link>
                  </div>
                </div>
