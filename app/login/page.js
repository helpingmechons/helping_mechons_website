    ...
    <form onSubmit={handleLogin} className="space-y-5">
      ...
      <div>
        <div className="flex justify-between items-center mb-2">
          ...
          <Link href="/forgot-password" className="font-caption text-caption text-secondary hover:opacity-80">
            Forgot password?
          </Link>
        </div>
      ...
      <div className="hidden lg:flex flex-col justify-between w-5/12 bg-primary p-12 relative overflow-hidden">
        ...
        <div className="relative z-10">
          <Link href="/" className="flex items-center gap-2">
            ...
            <span className="font-headline-md font-bold text-headline-md text-on-primary">
        ...
        <div className="relative z-10 space-y-4">
          ...
          <div className="flex gap-6 mt-8">
            {[{ stat: "1,200+", label: "Lives" }, { stat: "₹25L+", label: "Raised" }, { stat: "85K", label: "Students" }].map(({ stat, label }) => (
              <div key={label}>
                <p className="font-headline-md font-bold text-headline-md text-secondary-container">{stat}</p>
                <p className="font-caption text-caption text-on-primary-container uppercase tracking-wider">{label}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="flex items-center gap-2 mb-8 lg:hidden">
            <Link href="/" className="flex items-center gap-2">
              ...
              <span className="font-headline-md font-bold text-headline-md text-primary">Helping Mechons</span>
            </Link>
          </div>
          ...
          <Suspense fallback={<div className="h-48 animate-pulse bg-surface-container rounded-lg" />}>
            <LoginForm />
          </Suspense>
          ...
          <p className="font-caption text-caption text-on-surface-variant text-center mt-8">
