        ...
        <div className="md:hidden border-t border-outline-variant/30 bg-white">
          <div className="section-container py-4 flex flex-col gap-1">
            ...
            {isAdmin && (
              <Link
                href="/admin"
                className="px-4 py-3 rounded-lg text-body-md text-on-surface-variant hover:bg-surface-container transition-colors"
              >
                Admin Dashboard
              </Link>
            )}
            ...
            {user ? (
              <>
                ...
                <button
                  onClick={handleLogout}
                  className="px-4 py-3 rounded-lg text-body-md text-left text-secondary font-semibold hover:bg-secondary-fixed/30 transition-colors"
                >
                  Logout
                </button>
              </>
